...
public class Create_Cylinder_CRUD {
	...
	public void createCompanyCylinderTest() {
		...
		cylinderData.put("current_company_id", 9);
		cylinderData.put("current_location_id", 16);

		// cylinder_details
		cylinderData.put("manufacture_serial_number", "12Atul lokhande123");
